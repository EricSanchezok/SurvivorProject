...
func unregister_weapon(weapon_slot: int, weapon) -> void:
	match weapon_slot:
		1:
			weapon_1.remove_child(weapon)
		2:
			weapon_2.remove_child(weapon)
		3:
			weapon_3.remove_child(weapon)
		4:
			weapon_4.remove_child(weapon)
		5:
			weapon_5.remove_child(weapon)
		6:
			weapon_6.remove_child(weapon)
		7:
			weapon_7.remove_child(weapon)
		8:
			weapon_8.remove_child(weapon)
		9:
			weapon_9.remove_child(weapon)
