...
func unregister_weapon(weapon_slot: int) -> void:
	...
	:param weapon_slot: 武器槽位
	'''
	weapon_slot_instance = match weapon_slot:
		1:
			weapon_1
		2:
			weapon_2
	...
	match weapon_slot:
		1:
			var weapon = weapon_1.get_child(0)
			weapon_1.remove_child(weapon)
		2:
			var weapon = weapon_2.get_child(0)
			weapon_2.remove_child(weapon)
		3:
			var weapon = weapon_3.get_child(0)
			weapon_3.remove_child(weapon)
		4:
			var weapon = weapon_4.get_child(0)
