...
func register_weapon(weapon_slot: int, weapon) -> void:
	...
	match weapon_slot:
		1:
			weapon.add_child(path_follow_2d_1)
		2:
			weapon.add_child(path_follow_2d_2)
		3:
			weapon.add_child(path_follow_2d_3)
		4:
			weapon.add_child(path_follow_2d_4)
		5:
			weapon.add_child(path_follow_2d_5)
