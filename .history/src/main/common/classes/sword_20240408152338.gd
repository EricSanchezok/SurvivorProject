...
func _update_parameters() -> void:
	...
	magic_attack_power = playerStats.get("magic_attack_power")
	attack_range = playerStats.get("attack_range")
	attack_windup_speed = playerStats.get("attack_windup_speed")
	attack_backswing_speed = playerStats.get("attack_backswing_speed")
	attack_wait_time = playerStats.get("attack_wait_time")
	knockback = playerStats.get("knockback")
