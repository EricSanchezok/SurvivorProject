...
func move_to_target() -> void:
	...
	velocity.x = move_toward(velocity.x, dir.x * enemy_stats.base_movement_speed, enemy_stats.base_movement_acceleration)
	velocity.y = move_toward(velocity.y, dir.y * enemy_stats.base_movement_speed, enemy_stats.base_movement_acceleration)
...
func _on_hurt_box_hurt(hitbox: Variant) -> void:
	...
	print("health: %s" % enemy_stats.health)
