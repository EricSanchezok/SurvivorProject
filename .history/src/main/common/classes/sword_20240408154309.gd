...
func _update_parameters() -> void:
	...
	:return: void
	'''
	physical_attack_power = physical_attack_power * playerStats.physical_attack_power_multiplier * playerStats.attack_power_multiplier
	magic_attack_power = magic_attack_power * playerStats.magic_attack_power_multiplier * playerStats.attack_power_multiplier	
	attack_range = attack_range * playerStats.attack_range_multiplier
	attack_windup_speed = attack_windup_speed * playerStats.attack_speed_multiplier
	attack_backswing_speed = attack_backswing_speed * playerStats.attack_speed_multiplier
	attack_wait_time = attack_wait_time / playerStats.attack_speed_multiplier
	knockback = knockback * playerStats.knockback_multiplier
...
func _on_changed_attack_power_multiplier() -> void:
	physical_attack_power = physical_attack_power * playerStats.attack_power_multiplier
	magic_attack_power = magic_attack_power * playerStats.attack_power_multiplier
