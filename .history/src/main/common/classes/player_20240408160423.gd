...
func move(delta: float) -> void:
	...
	velocity.x = movement.x * playerStats.base_movement_speed * playerStats.movement_speed_multiplier
	velocity.y = movement.y * playerStats.base_movement_speed * playerStats.movement_speed_multiplier
	move_and_slide()
