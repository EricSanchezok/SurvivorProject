...
func _update_parameters() -> void:
	...
	# 重置属性
	enemy_stats.health = base_max_health
	enemy_stats.health_regeneration = base_health_regeneration
	enemy_stats.recovery_time = base_recovery_time
	enemy_stats.physical_attack_power = base_physical_attack_power
	enemy_stats.magic_attack_power = base_magic_attack_power
