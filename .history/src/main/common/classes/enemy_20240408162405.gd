...
func move_to_target() -> void:
	...
	velocity = dir * enemy_stats.base_movement_speed
...
func _on_hurt_box_hurt(hitbox: Variant) -> void:
	...
	print("Enemy: %s" % pending_damage.source)
	print("Enemy: %s" % pending_damage.amount)
	print("Enemy: %s" % pending_damage.knockback)
