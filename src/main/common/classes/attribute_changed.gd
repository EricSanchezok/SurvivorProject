...
enum Classes { SWORD, SHIELD, AXE, SPEAR, HAMMER, DAGGER, ARMOR, RING, BOOMERANG, BOW, WAND, LASERWAND, SCROLL, GUN, TURRET, BOMB }


# 定义属性
enum Attributes {
	POWER_PHYSICAL, POWER_MAGIC,  TIME_COOLDOWN,  RADIUS_SEARCH, KNOCKBACK, CRITICAL_HIT_RATE, CRITICAL_DAMAGE, NUMBER_OF_PROJECTILES,
	SPEED_FLY, PENETRATION_RATE
}
